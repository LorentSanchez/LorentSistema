...
namespace SistemaF.Web.Controllers
{
    public class MonedasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Moneda_Id,Name_moneda,Tasa_moneda,Nmoneda")] Moneda moneda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Moneda_Id,Name_moneda,Tasa_moneda,Nmoneda")] Moneda moneda)
        {
            if (ModelState.IsValid)
            {
